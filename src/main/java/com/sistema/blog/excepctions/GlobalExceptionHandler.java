package com.sistema.blog.excepctions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetalles> manejaResourceNotFoundException(ResourceNotFoundException exception, WebRequest webRequest){
